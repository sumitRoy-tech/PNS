...
class PurchaseData(Base):
    ...
    # GENERATED PO DOCUMENT FIELDS
    po_content = Column(Text, nullable=True)  # Full PO text content generated by AI
    po_filename = Column(String(255), nullable=True)  # PDF filename
    po_filepath = Column(String(500), nullable=True)  # Full path to PDF
    file_size_kb = Column(Float, nullable=True)  # File size in KB
